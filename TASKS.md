...
Generated by the Elyos task-decomposition agent on 2026-06-29. All 27 files validated against
`packages/schema/dist/index.js` (validateTask). Seed file (`schema-001`) was already committed;
the remaining 26 files were generated and validated in this run.

| File | Milestone | Type | Deliverable | Risk | verifiedNeed |
|---|---|---|---|---|---|
| [tasks/multilingual-museum-labels-schema-001.json](tasks/multilingual-museum-labels-schema-001.json) | M0 | code | pr | low | false |
| [tasks/multilingual-museum-labels-rights-001.json](tasks/multilingual-museum-labels-rights-001.json) | M0 | data | dataset | low | false |
| [tasks/multilingual-museum-labels-guide-001.json](tasks/multilingual-museum-labels-guide-001.json) | M0 | writing | document | low | false |
| [tasks/multilingual-museum-labels-guide-002.json](tasks/multilingual-museum-labels-guide-002.json) | M0 | writing | document | medium | false |
| [tasks/multilingual-museum-labels-review-001.json](tasks/multilingual-museum-labels-review-001.json) | M0 | writing | document | low | false |
| [tasks/multilingual-museum-labels-review-002.json](tasks/multilingual-museum-labels-review-002.json) | M0 | writing | document | low | false |
| [tasks/multilingual-museum-labels-glossary-001.json](tasks/multilingual-museum-labels-glossary-001.json) | M0 | data | dataset | medium | false |
| [tasks/multilingual-museum-labels-license-000.json](tasks/multilingual-museum-labels-license-000.json) | M0 | research | document | low | false |
| [tasks/multilingual-museum-labels-exemplar-001.json](tasks/multilingual-museum-labels-exemplar-001.json) | M0 | writing | document | medium | false |
| [tasks/multilingual-museum-labels-exemplar-002.json](tasks/multilingual-museum-labels-exemplar-002.json) | M0 | writing | translation | medium | false |
| [tasks/multilingual-museum-labels-tooling-001.json](tasks/multilingual-museum-labels-tooling-001.json) | M0 | code | pr | low | false |
| [tasks/multilingual-museum-labels-reviewers-001.json](tasks/multilingual-museum-labels-reviewers-001.json) | M1 | writing | document | low | false |
| [tasks/multilingual-museum-labels-reviewers-002.json](tasks/multilingual-museum-labels-reviewers-002.json) | M1 | research | document | low | false |
| [tasks/multilingual-museum-labels-glossary-002.json](tasks/multilingual-museum-labels-glossary-002.json) | M1 | data | dataset | medium | false |
| [tasks/multilingual-museum-labels-license-002.json](tasks/multilingual-museum-labels-license-002.json) | M1 | code | pr | low | false |
| [tasks/multilingual-museum-labels-watcher-001.json](tasks/multilingual-museum-labels-watcher-001.json) | M1 | code | pr | low | false |
| [tasks/multilingual-museum-labels-escalation-001.json](tasks/multilingual-museum-labels-escalation-001.json) | M1 | writing | document | medium | false |
| [tasks/multilingual-museum-labels-exemplar-003.json](tasks/multilingual-museum-labels-exemplar-003.json) | M1 | writing | translation | medium | false |
| [tasks/multilingual-museum-labels-partner-001.json](tasks/multilingual-museum-labels-partner-001.json) | M2 | research | document | low | false |
| [tasks/multilingual-museum-labels-ingest-001.json](tasks/multilingual-museum-labels-ingest-001.json) | M2 | data | dataset | medium | false |
| [tasks/multilingual-museum-labels-produce-001.json](tasks/multilingual-museum-labels-produce-001.json) | M2 | writing | document | medium | false |
| [tasks/multilingual-museum-labels-translate-001.json](tasks/multilingual-museum-labels-translate-001.json) | M2 | writing | translation | medium | false |
| [tasks/multilingual-museum-labels-delivery-001.json](tasks/multilingual-museum-labels-delivery-001.json) | M2 | writing | document | medium | false |
| [tasks/multilingual-museum-labels-scale-001.json](tasks/multilingual-museum-labels-scale-001.json) | M3 | writing | translation | medium | false |
| [tasks/multilingual-museum-labels-rotation-001.json](tasks/multilingual-museum-labels-rotation-001.json) | M3 | maintenance | document | low | false |
| [tasks/multilingual-museum-labels-outcomes-001.json](tasks/multilingual-museum-labels-outcomes-001.json) | M3 | data | dataset | low | false |
| [tasks/multilingual-museum-labels-maint-001.json](tasks/multilingual-museum-labels-maint-001.json) | M3 | maintenance | document | low | false |

**Fan-out dimensions:** none — no explicitly enumerated dimensions in PLAN.md/TASKS.md requiring
fan-out (language pairs and objects are TBD; the backlog has one task per language-pair glossary
and one task per exemplar batch as written).

**verifiedNeed policy:** all tasks carry `verifiedNeed: false` because no partner museum is yet
secured. M2/M3 tasks update to `true` when `partner-001` is complete and the rights grant is confirmed.
